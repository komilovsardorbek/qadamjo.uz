...
jQuery(document).on('ready', function() {
	...
	/* -------------------------------------
			POPULAR tOUR SLIDER
	-------------------------------------- */
	var _tg_productdetailsider1 = jQuery('#tg-productdetailsider1');
	_tg_productdetailsider1.owlCarousel({
		items:1,
		dots: false,
		nav: true,
		loop: true,
	...
	var _tg_productdetailsider2 = jQuery('#tg-productdetailsider2');
	_tg_productdetailsider2.owlCarousel({
		items:1,
		dots: false,
		nav: true,
		loop: true,
	...
	var _tg_productdetailsider3 = jQuery('#tg-productdetailsider3');
	_tg_productdetailsider3.owlCarousel({
		items:1,
		dots: false,
		nav: true,
		loop: true,
	...
	var _tg_productdetailsider4 = jQuery('#tg-productdetailsider4');
	_tg_productdetailsider4.owlCarousel({
		items:1,
		dots: false,
		nav: true,
		loop: true,
	...
	var _tg_productdetailsider5 = jQuery('#tg-productdetailsider5');
	_tg_productdetailsider5.owlCarousel({
		items:1,
		dots: false,
		nav: true,
		loop: true,
	...
	var _tg_productdetailsider6 = jQuery('#tg-productdetailsider6');
	_tg_productdetailsider6.owlCarousel({
		items:1,
		dots: false,
		nav: true,
		loop: true,
	...
	/* ---------------------------------------
			FULL google map
	--------------------------------------- */
	jQuery('a[href="#tg-view"]').on('click', function(event) {
		event.preventDefault();
		jQuery('#tg-view').addClass('open');
		jQuery('#tg-view > form > fieldset > input[type="search"]').focus();
	});
	jQuery('#tg-view, #tg-view button.close').on('click keyup', function(event) {
		if (event.target == this || event.target.className == 'close' || event.keyCode == 27) {
			jQuery(this).removeClass('open');
		}
	});
	...
	/* ---------------------------------------
			FULL google map
	--------------------------------------- */
	jQuery('a[href="#tg-map"]').on('click', function(event) {
		event.preventDefault();
		jQuery('#tg-map').addClass('open');
		jQuery('#tg-map > form > fieldset > input[type="search"]').focus();
	});
	jQuery('#tg-map, #tg-map button.close').on('click keyup', function(event) {
		if (event.target == this || event.target.className == 'close' || event.keyCode == 27) {
			jQuery(this).removeClass('open');
		}
	});
